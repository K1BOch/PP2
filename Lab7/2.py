...
def load_music():
    songs = []
    list_of_music = os.listdir(r'C:\Users\Professional\Desktop\PP2\Lab7\music')
...
pygame.display.set_icon(pygame.image.load(r"C:\Users\Professional\Desktop\PP2\Lab7\image\player.png"))

surf_1 = pygame.Surface((340, 55))

icon_play = pygame.image.load(r'C:\Users\Professional\Desktop\PP2\Lab7\image\\play.png').convert_alpha()
