...
mickey_surf = pygame.image.load("image\mickey_clock.png")
left_hand_surf = pygame.image.load("image\mickey_left.png").convert_alpha()
right_hand_surf = pygame.image.load("image\\mickey_right.png").convert_alpha()
